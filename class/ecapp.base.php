...
/* begin 2014-05-09 by sunfp */
/* 权限列表 */  
define('OVERVIEW','1_1');
define('MYPROFILE','1_2');
define('MEMBER_SCORES','1_3');
define('MEMBER_CASH','1_4');
define('MEMBER_COMMISSION','1_5');
define('MAKE_MONEY','1_6');

define('ROLE_SETTINGS','2_7');
define('USER_MANAGEMENT','2_8');

define('MY_STORE','2_9');
define('ALIPAY','2_10');
define('LUNBO','2_11');
define('MY_GOODS','2_12');
define('MY_CATEGORY','2_13');
define('ORDER_MANAGE','2_14');
define('MY_THEME','2_15');
define('MY_SHIPPING','2_16');
define('STORE_SCORES','2_17');
define('STORE_CASH','2_18');
define('WITHDRAWALS','2_19');
define('MEM_COMMISSION','2_20');
define('ADVERT_LIST','2_21');
define('AD_APPLY','2_22');
define('AD_PROFIT','2_23');
define('MEM_SCORES','2_24');

define('WECHAT_INDEX','2_25');
define('FOLLOW_INDEX','2_26');
define('KEYWORD_INDEX','2_27');
define('MESSAGE_INDEX','2_28');
define('CUSTOM_MENU','2_29');
/* end 2014-05-09 by sunfp*/
...
EOT;
    ...
    function display($f)
    {
        ...
        $this->assign('wmshop_version', VERSION);
...
class BaseVisitor extends Object
{
    ...
    function _get_detail()
    {
        ...
        /* begin 2014-07-18 by sunfp */
        $before_member_info = $model_member->get($this->info['user_id']);
        if($before_member_info['belong_store_id'] && $before_member_info['belong_store_id'] != -1)
        {
            $belong_user_id = $before_member_info['belong_store_id'];
        }else{
            $belong_user_id = $this->info['user_id'];
        }
        /*  end 2014-07-18 by sunfp*/
        
        /* 获取当前用户的详细信息，包括权限 */
        $member_info = $model_member->findAll(array(
            'conditions'    => "member.user_id = '{$belong_user_id}'",//$this->info['user_id']
            'join'          => 'has_store',                 //关联查找看看是否有店铺
            'fields'        => 'email, password, real_name, logins, ugrade, portrait, store_id, state, sgrade , feed_config,belong_store_id',//添加belong_store_id
        ...
        /* beging 2014-05-09 by sunfp */
//        /* 判断是否有从属商城id */
        if($detail['belong_store_id'] && $detail['belong_store_id'] != -1)
        {
            $detail['manage_store'] = $detail['has_store'] = $detail['belong_store_id'];
        }
//        /* end 2014-05-09 by sunfp */
        return $detail;
    }
